        ...
        <div class="row">
            <div class="col-12">
                            ...
                            <table class="table table-striped tablas">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row['pro_precio_c']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['marca_descripcion']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row['catego_descripcion']; ?>
                                        </td>
                                        <td>
                                            <?php
              ...
              ?>
                                        ...
                                        <td>
                                            <img src="imagenes/<?php echo $row['pro_imagen']; ?>" width="60"
                                                height="60">
                                        </td>
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning" data-toggle="modal"
                                                data-target="#ModalEditar<?php echo $row['pro_id']; ?>">
                                                Editar
                                            </button>

                                            <!-- Modal  EDITAR-->
                                            <div class="modal fade" id="ModalEditar<?php echo $row['pro_id']; ?>"
                    ...
                    ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <div class="card card-primary">
                                                                            <div class="card-body">
                                                                                <input type="hidden"
                                                                                    name="txtFotoAnterior"
                                                                                    value="<?php echo $datosPro['pro_imagen']; ?>">
                                                                                <label>Codigo :</label>
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="text" name="txtCodigo"
                                                                                        id="txtCodigoId"
                                                                                        value="<?php echo $datosPro['pro_id']; ?>"
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="text" name="txtDesc"
                                                                                        value="<?php echo $datosPro['pro_descripcion']; ?>"
                                                                                        class="form-control"
                                                                                        placeholder="Codigo">
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        name="txtPrecioC"
                                                                                        value="<?php echo $datosPro['pro_precio_c']; ?>"
                                                                                        class="form-control"
                                                                                        maxlength="10">
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        name="txtPrecioV"
                                                                                        value="<?php echo $datosPro['pro_precio_v']; ?>"
                                                                                        class="form-control">
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="number" name="txtStock"
                                                                                        value="<?php echo $datosPro['pro_stock']; ?>"
                                                                                        class="form-control">
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="date"
                                                                                        name="txtFechaElab"
                                                                                        value="<?php echo $datosPro['pro_fecha_elab']; ?>"
                                                                                        class="form-control">
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <span class="input-group-text"
                                                                                        id="basic-addon1">#</span>
                                                                                    <select name="cboNivelAzucar"
                                                                                        class="form-select">
                                                                                        <option value="B" <?php if
                                                                                            ($datosPro['pro_nivel_azucar']=="B"
                                                                                            ) { echo "selected" ; } ?>
                                                                                            >Bajo</option>
                                                                                        <option value="M" <?php if
                                                                                            ($datosPro['pro_nivel_azucar']=="M"
                                                                                            ) { echo "selected" ; } ?>
                                                                                            >Medio</option>
                                                                                        <option value="A" <?php if
                                                                                            ($datosPro['pro_nivel_azucar']=="A"
                                                                                            ) { echo "selected" ; } ?>
                                                                                            >Alto</option>
                                                                                        <option value="N" <?php if
                                                                                            ($datosPro['pro_nivel_azucar']=="N"
                                                                                            ) { echo "selected" ; } ?>
                                                                                            >Ninguno</option>
                                                                                    </select>
                                                                                </div>
                                                                        ...
                                                                        <div class="card card-primary">
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <input name="chkPagaIva" <?php if
                                                                                        ($datosPro['pro_aplica_iva']==1)
                                                                                        echo "checked" ; ?>
                                                                                    class="form-check-input"
                                                                                    type="checkbox">
                                                                                    <label
                                                                                        class="form-check-label"><strong>Paga
                                                                                            Iva</strong></label>
                                                                                </div>
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <span class="input-group-text"
                                                                                        id="basic-addon1">#</span>
                                                                                    <textarea name="txtEspecifica"
                                                                                        class="form-control"><?php echo $datosPro['pro_especifica']; ?></textarea>
                                                                                </div>
                                                                                <!-- imagen -->
                                                                                <div class="input-group">
                                                                                    <p>
                                                                                        <img src="imagenes/<?php echo $datosPro['pro_imagen']; ?>"
                                                                                            id="imguserId"
                                                                                            class="img-circle"
                                                                                            height="150" width="150" />
                                                                                        <input class="input-group"
                                                                                            type="file" name="imguser"
                                                                                            id="fotoId"
                                                                                            onchange="previewFoto()"
                                                                                            accept="image/*">
                                                                                        <label
                                                                                            for="ejemplo_archivo_1">Imagen
                                                                                            (Tam. máximo archivo
                                                                                            1 MB)</label>
                                                                                    </p>
                                                                                </div>
                              ...
                              ?>
                                                                                ...
                                                                                <select class="form-select"
                                                                                    name="cboMarcas" required>
                                                                                    <option
                                                                                        value="<?php echo $datosPro['marca_id']; ?>">
                                                                                        <?php echo MarcaData::getNombeMarcaById($datosPro['marca_id']); ?>
                                                                                    </option>
                                                                                    <?php
                                if ($marcas != null) {
                                ...
                                ?>
                                                                                    <option
                                                                                        value="<?php echo $rowm['marca_id']; ?>">
                                                                                        <?php echo $rowm['marca_descripcion']; ?>
                                                                                    </option>
                                                                                    <?php
                                    }
                                  }
                              ...
                              ?>
                                                                                ...
                                                                                <select class="form-select"
                                                                                    name="cboCategorias" required>
                                                                                    <option
                                                                                        value="<?php echo $datosPro['catego_id']; ?>">
                                                                                        <?php echo CategoriaData::getNombreCategoriaById($datosPro['catego_id']); ?>
                                                                                    </option>
                                                                                    <?php
                                if ($categorias != null) {
                                ...
                                ?>
                                                                                    <option
                                                                                        value="<?php echo $rowc['catego_id']; ?>">
                                                                                        <?php echo $rowc['catego_descripcion']; ?>
                                                                                    </option>
                                                                                    <?php
                                  }
                                }
                                ?>
                                                                                ...
                                                                                <button type="submit" name="btnUpdate"
                                                                                    class="btn btn-primary btn-sm mt-2">Grabar
                                                                                    cambios</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#ModalEliminar<?php echo $row['pro_id']; ?>">
                                                Eliminar
                                            </button>

                                            <!-- Modal  Eliminar-->
                                            <div class="modal fade" id="ModalEliminar<?php echo $row['pro_id']; ?>"
                                                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="txtCodigo" id="txtCodigoId" class="form-control"
                                            placeholder="Codigo">
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="card card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <p>
                                            <img src="imagenes/sinimagen.jpeg" id="imguserId" class="img-circle"
                                                height="150" width="150" />
                                            <input class="input-group" type="file" name="imguser" id="fotoId"
                                                onchange="previewFoto()" accept="image/*">
                  ...
                  ?>
                    ...
                    if ($marcas != null) {
                      foreach ($marcas as $indice => $rowm) {
                    ?>
                                        <option value="<?php echo $rowm['marca_id']; ?>">
                                            <?php echo $rowm['marca_descripcion']; ?>
                                        </option>
                                        <?php
                      }
                  ...
                  ?>
                    ...
                    if ($categorias != null) {
                      foreach ($categorias as $indice => $rowc) {
                    ?>
                                        <option value="<?php echo $rowc['catego_id']; ?>">
                                            <?php echo $rowc['catego_descripcion']; ?>
                                        </option>
                                        <?php
                      }
                    ...
                    ?>
                                    ...
                                    <!--  -->
                                    <button type="submit" name="btnGrabar"
                                        class="btn btn-primary btn-sm mt-2">Grabar</button>
                                </div>
                            </div>
                        </div>
                    </div>
